...
Route::post('saw/kegiatan/create', [KegiatanController::class, 'createData']);


Route::post('saw/login', [AuthController::class, 'login']);
...
Route::middleware(['auth', 'web'])->group(function () {
    ...
    Route::post('saw/logout', [AuthController::class, 'logout']);
});
